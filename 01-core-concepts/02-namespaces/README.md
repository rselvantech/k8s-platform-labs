...
"Are RBAC Roles namespace-scoped or cluster-scoped?","Namespace-scoped — a Role/RoleBinding in one namespace grants no access elsewhere; use ClusterRole/ClusterRoleBinding for cluster-wide permissions","demo02,rbac,namespaces,ckad-application-environment-configuration-security"
